...
namespace Concesionaria
{
    class Test
    {
        ...
        public static void Main() { 
            ...
            Camioneta g = new Camioneta(2005, "Chevrolet", "S-10", 1245987, 520698, Combustible.Gasoil, 15000, 2000, "Echa un poco de humo.");
            Camioneta h = new Camioneta(1983, "Chevrolet", "Silverado", 1245987, 520698, Combustible.Gasoil, 15000, 2000, "Echa un poco de humo.");
            Camioneta i = new Camioneta(1980, "Toyota", "Hylux", 1245987, 520698, Combustible.Gasoil, 15000, 2000, "Echa un poco de humo.");
            ...
            //conse.buscarVehiculoPorAnio(2000);
            //conse.buscarVehiculoPorPrecio(4500);
